...
- **Détection automatique du manche pour la Phase 1** — le prototype de détection des frettes échoue sans région d'intérêt (matche du bruit de fond sur toute la photo), et même avec un recadrage manuel sur la silhouette de la guitare, reste sensible à l'angle/au centrage (échoue sur une photo légèrement de travers). La boîte englobante de la Phase 0 (OWLv2, guitare entière) ne suffit pas. **OWLv2 en requêtes par pièce testé (§8bis puis §9, 8 formulations au total) et toujours écarté comme solution complète** : "the nut of a guitar neck" est la piste la plus prometteuse (seule requête cohérente sur 4 photos test) mais la boîte n'est pas assez serrée et ne couvre pas jusqu'au chevalet ; "the saddle of a guitar bridge" est activement trompeuse (se verrouille sur la tête au lieu du chevalet, de façon reproductible) ; les autres formulations (fretboard/fingerboard/headstock/neck/bridge) retombent sur des boîtes trop larges ou nulles. **SAM 2.1 en segmentation point-guidée en cours de test (§10, 2026-08-24)** — mise en place technique faite (1 bug corrigé), résultat visuel pas encore documenté.
