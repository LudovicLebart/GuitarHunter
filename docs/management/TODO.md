...
- [x] **Annonce Facebook active jamais capturée (id 4380960138835811, Saint-Bruno-de-Montarville, 295$)** *(Signalé 2026-08-25, cause racine confirmée et corrigée le même jour)*
    ...
    - *Reste à faire* : valider en conditions réelles après fusion que le prochain cycle Facebook (ancrage Saint-Bruno-de-Montarville) retrouve bien des annonces locales cohérentes.
