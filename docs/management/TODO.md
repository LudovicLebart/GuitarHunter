...
- [x] **Outillage Dataset B** (§5 du plan) — 2 fiches imprimables (protocole cale/photo + grille de mesures, `docs/assets/dataset_b_protocole/`) et base locale CSV→SQLite facile à mettre à jour (`backend/scripts/dataset_b/`).
