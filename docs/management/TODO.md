...
- [ ] **Localisation manche/sillet/chevalet — tester SAM 2.1 en segmentation point-guidée** (§10 du plan, en cours) — bug de mise en place corrigé (`reshaped_input_sizes`), rerun déclenché, résultat visuel pas encore inspecté.
