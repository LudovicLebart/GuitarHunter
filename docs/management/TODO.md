...
- [x] **Annonce Facebook active jamais capturée (id 4380960138835811, Saint-Bruno-de-Montarville, 295$)** *(Signalé 2026-08-25, cause racine confirmée et corrigée le même jour)*
    ...
    - *Reste à faire* : (1) **corriger les coordonnées de "Saint-lambert"** vers le vrai Saint-Lambert québécois (Rive-Sud de Montréal, ~45.5/-73.5) — correction de donnée via le ConfigPanel de l'app, pas de code à changer ; (2) revalider si le remplissage international persiste après cette correction ; (3) que l'annonce d'origine (ou une similaire) remonte enfin dans un cycle automatique.
