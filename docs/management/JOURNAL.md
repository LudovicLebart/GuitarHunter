...
[2026-08-24] [PRO] Validation en cours : couverture d'un ancrage à rayon large vs boucle 22 villes → Résultat :
...
- **Armé via `run_once.py`**, push en cours. Résultat et conclusion à compléter dans cette même entrée une fois les logs GitHub Actions lus.
