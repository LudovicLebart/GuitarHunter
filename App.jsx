...
const CITY_COORDINATES = {
  ...
  'saguenay': { lat: 48.4284, lng: -71.0700 },
  'trois-rivieres': { lat: 46.3430, lng: -72.5421 },
  'trois-rivières': { lat: 46.3430, lng: -72.5421 },
  ...
  'saint-louis-de-gonzague': { lat: 45.2000, lng: -73.9833 },
  ...
  'sainte-sabine': { lat: 45.2333, lng: -73.0167 },
  ...
  'saint-damase': { lat: 45.5167, lng: -73.0000 },
  ...
  'saint-simon': { lat: 45.7333, lng: -72.8667 },
  ...
  'sainte-monique': { lat: 46.1667, lng: -72.5333 },
  ...
  'sainte-perpétue': { lat: 46.0833, lng: -72.4167 },
  ...
  'saint-cyprien': { lat: 46.3500, lng: -70.2667 },
  ...
  'saint-séverin': { lat: 46.3167, lng: -71.0500 },
  ...
  'saint-isidore': { lat: 46.5833, lng: -71.0833 },
  ...
  'sainte-félicité': { lat: 46.9667, lng: -69.9833 },
  ...
  'sainte-françoise': { lat: 48.1167, lng: -69.0500 },
  ...
  'sainte-jeanne-d\'arc': { lat: 48.5167, lng: -67.9333 },
  ...
  'saint-augustin': { lat: 51.2333, lng: -58.6500 },
  ...
  'rivière-héva': { lat: 48.2000, lng: -78.2000 },
  'duparquet': { lat: 48.5000, lng: -79.2167 },
  'rapide-danseur': { lat: 48.5500, lng: -79.3000 },
  ...
  'saint-augustin': { lat: 48.8000, lng: -72.0167 },
...
const MapView = ({ deals, onDealSelect }) => {
  ...
  useEffect(() => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyDtr1pAc2oTWxnDyMHUclkt4G34qdAAAXw&callback=initMap&v=weekly`;
    script.async = true;
    script.defer = true;
